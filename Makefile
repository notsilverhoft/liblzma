...
DIST_COMMON = README $(am__configure_deps) $(dist_doc_DATA) \
	$(dist_examples_DATA) $(dist_examplesold_DATA) \
...
ACLOCAL = ${SHELL} /workspace/WasmFlash/liblzma/build-aux/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
...
AR = /workspace/WasmFlash/emsdk/upstream/emscripten/emar
AS = as
AUTOCONF = ${SHELL} /workspace/WasmFlash/liblzma/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /workspace/WasmFlash/liblzma/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /workspace/WasmFlash/liblzma/build-aux/missing --run automake-1.12
AWK = gawk
CC = /workspace/WasmFlash/emsdk/upstream/emscripten/emcc
CCAS = /workspace/WasmFlash/emsdk/upstream/emscripten/emcc
...
INTLLIBS = 
INTL_MACOSX_LIBS = 
LD = /workspace/WasmFlash/emsdk/upstream/emscripten/emcc
LDFLAGS = 
LIBICONV = 
LIBINTL = 
LIBOBJS = 
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /workspace/WasmFlash/liblzma/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /usr/bin/mkdir -p
MSGFMT = :
MSGFMT_015 = :
MSGMERGE = :
NM = /workspace/WasmFlash/emsdk/upstream/bin/llvm-nm
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
...
PTHREAD_CC = /workspace/WasmFlash/emsdk/upstream/emscripten/emcc
PTHREAD_CFLAGS = 
PTHREAD_LIBS = 
RANLIB = /workspace/WasmFlash/emsdk/upstream/emscripten/emranlib
RC = 
SED = /usr/bin/sed
SET_MAKE = 
SHELL = /bin/bash
...
XGETTEXT = :
XGETTEXT_015 = :
abs_builddir = /workspace/WasmFlash/liblzma
abs_srcdir = /workspace/WasmFlash/liblzma
abs_top_builddir = /workspace/WasmFlash/liblzma
abs_top_srcdir = /workspace/WasmFlash/liblzma
ac_ct_AR = 
ac_ct_CC = /workspace/WasmFlash/emsdk/upstream/emscripten/emcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /workspace/WasmFlash/liblzma/build-aux/install-sh
...
pdfdir = ${docdir}
prefix = /workspace/WasmFlash/liblzma/build/liblzma
